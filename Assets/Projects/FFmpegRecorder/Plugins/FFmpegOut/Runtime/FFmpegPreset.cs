    ...
    static public class FFmpegPresetExtensions
    {
        public static string GetDisplayName(this FFmpegPreset preset)
        {
            switch (preset)
            {
                ...
                case FFmpegPreset.H264Default_Custom: return "H.264 Default (MP4)";
        ...
        public static string GetSuffix(this FFmpegPreset preset)
        {
            switch (preset)
            {
                ...
                case FFmpegPreset.H264Default_Custom:
        ...
        public static string GetOptions(this FFmpegPreset preset)
        {
            switch (preset)
            {
                ...
                case FFmpegPreset.H264Default_Custom: return "-pix_fmt yuv420p -preset slow -crf 18";
